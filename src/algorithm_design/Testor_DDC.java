...
public class Testor_DDC {
	...
	public static final boolean nonFateSharing = true;// true - no fate sharing model
	public static final boolean relibilityFirst = false;
	...
	public static void main(String[] args) throws InterruptedException {
		...
		for (int i = 0; i < variables.length; i++) {
			...
			DDCThread thread = new DDCThread(SHUFFLE, nonFateSharing, vmNum, lower, upper, new Random(i),
					relibilityFirst, "#of requests = " + vmNum);
